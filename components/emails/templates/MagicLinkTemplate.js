        ...
        <EmailContainer style={{ backgroundColor: base200, padding: '60px 20px', fontFamily: font }}>
          <EmailContainer style={{
            ...
            <div style={{ textAlign: 'center', marginBottom: '40px' }}>
              <h2 style={{ fontSize: '22px', fontWeight: 700, margin: '0 0 16px 0', color: content }}>
                Sign in to {host}
              </h2>
              <p style={{ fontSize: '16px', color: content, opacity: 0.8, marginBottom: '32px', lineHeight: 1.5 }}>
            ...
            <div style={{ borderTop: `1px solid ${dividerColor}`, paddingTop: '32px', marginTop: '32px' }}>
              <p style={{ fontSize: '14px', color: content, opacity: 0.7, textAlign: 'center', margin: 0, lineHeight: 1.4 }}>
