...
import InputCheckbox from "@/modules/general/components/input/InputCheckbox";
  ...
  return (
    <SettingsContainer>
      <InputToggle
        ...
        value={getVal(`${prefix}.isEnabled`, true)}
        onChange={(checked) => handleChange(`${prefix}.isEnabled`, checked)}
        disabled={disabled}
      />

      {getVal(`${prefix}.isEnabled`, true) && (
        <>
          <SettingsRow>
            <InputCheckbox
              label="Show Date"
              ...
              onChange={(checked) =>
                handleChange(`${prefix}.showDate`, checked)
              }
              disabled={disabled}
            />
            <InputCheckbox
          ...
          <SettingsItem>
            ...
            <Input
              ...
              onChange={(e) =>
                handleChange(`${prefix}.buttonText`, e.target.value)
              }
