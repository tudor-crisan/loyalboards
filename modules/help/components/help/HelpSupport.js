...
export default function HelpSupport() {
  ...
  return (
    <div
      className={`${styling.components.card} mt-8 bg-base-200 ${styling.general.box}`}
    >
      <Grid>
        <div>
          ...
          <div className="space-y-4 mt-4">
            <div>
              <span className="font-bold block text-xs opacity-70 uppercase tracking-wider mb-1">
                Email&nbsp;
              </span>
              <Link
        ...
        <div>
          ...
          <div className="space-y-4 mt-4">
            ...
            <div>
              ...
              <p>
                {settings.business.address_line1}
                <br />
                {settings.business.address_line2}
                <br />
